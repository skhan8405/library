...
<Story name="With row expansion">
    <GridComponent passColumnToExpand={true} />;
</Story>
...
<Story name="With column expansion">
    <GridComponent expandableColumn={true} />;
</Story>
...
<Story name="With grid refresh">
    <GridComponent onGridRefresh={onGridRefresh} />;
</Story>
...
<Story name="With pagination">
    <GridComponent isNextPageAvailableCheck={true} />;
</Story>
